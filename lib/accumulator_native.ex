defmodule AccumulatorNative do
  @moduledoc """
  ...
  import AccumulatorWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([AccumulatorWeb, CoreComponents, plugin.module_suffix])
