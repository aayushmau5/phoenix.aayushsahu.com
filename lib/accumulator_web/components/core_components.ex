defmodule AccumulatorWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block min-h-[6rem] w-full border-zinc-300 py-[7px] px-[11px] font-sans",
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full border-zinc-300 py-[7px] px-[11px] font-sans",
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AccumulatorWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AccumulatorWeb.Gettext, "errors", msg, opts)
    # end
